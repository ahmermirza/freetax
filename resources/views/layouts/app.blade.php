        ...
        <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
            ...
            <ul class="navbar-nav">
                ...
                @guest
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark font-weight-bold p-3 pe-5" href="{{ route('register') }}">Register</a>
                    </li>
                @endguest
            </ul>
        </div>
                ...
                <div class="col-xl-9">
                    <ul class="navbar-nav d-xl-flex justify-content-between">
                        <li class="nav-item dropdown nav-custom-item px-lg-1 px-xl-1" role="button">
                            ...
                            <ul class="dropdown-menu dropdown-menu-white round-3 mt-3 shadow bg-white"
                        ...
                        <li class="nav-item dropdown nav-custom-item px-lg-1 px-xl-1" role="button">
                            ...
                            <ul class="dropdown-menu dropdown-menu-white dropdown-menu-end round-3 mt-3 shadow bg-white"
                                aria-labelledby="navbarDarkDropdownMenuLink">
                                <li><a class="dropdown-item" href="#"><i class="fa fa-check text-success"
                                            aria-hidden="true"></i>&nbsp;&nbsp;Action</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fa fa-check text-success"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <p>This privacy statement applies to www.FreeTaxUSA.com which is owned and operated by TaxHawk,
                                ...
                                identifiable information you provide on our web site: <a
                                    href="http://www.FreeTaxUSA.com/">www.FreeTaxUSA.com</a> ("FreeTaxUSA.com"). It also
                                describes the choices available to you regarding our use of your personally identifiable
                                information and how you can access and update this information. FreeTaxUSA.com treats your
                                financial and personally identifiable information as confidential and will not sell or rent
                                any information.</p>
                            ...
                            <p>TaxHawk, Inc. is the sole owner of the information collected on www.FreeTaxUSA.com.
                                Information is collected in order for taxpayers to prepare and electronically file their tax
                                returns. Tax return information is disclosed to appropriate government and financial
                                institutions to file tax returns and comply with Internal Revenue Service requirements. The
                                data collected includes everything that is needed to prepare a tax return, such as names,
                                Social Security numbers, birth dates, mailing address, email address, bank account
                                information, and any tax-related information (e.g., W-2s and 1099 forms). If a purchase is
                                made, credit card information for a credit card payment will be collected. Information may
                                also be collected from customers who contact us for support. The information collected, such
                                as a phone number, will be used to research and resolve customer questions.</p>
                            <p>To comply with European Union (EU) and European Economic Area (EEA) regulatory requirements,
                                we do not provide service or intentionally collect data from EU or EEA residents. By using
                            ...
                            <p>All personally identifiable information collected during account creation and use of the
                                application to prepare taxes is encrypted using Secure Socket Layer (SSL) technology.</p>
                            <p>We may provide a referral service, allowing you to inform a friend about our products. We
                                ...
                                information for the sole purpose of sending this one-time email and tracking the success of
                                our referral program. Your friend may contact us at <a
                                    href="mailto:webmaster@FreeTaxUSA.com">webmaster@FreeTaxUSA.com</a> to request that we
                            ...
                            <p>All data collected by us will be retained for a maximum period of eight (8) years calculated
                                from October 31st of the IRS tax filing deadline year in which the return is due. Data will
                                be deleted after October 31st of the 8th year following the IRS tax filing deadline year,
                                regardless of the year the return is actually filed.</p>
                            <p>For example:</p>
                            <ul>
                                <li>Data collected for a 2023 tax return (which has an IRS tax filing deadline in 2024) will
                                    be retained until October 31, 2032.</li>
                                <li>Data collected for a 2016 tax return (which has an IRS tax filing deadline in 2017) will
                                    be retained until October 31, 2025. Even if the return was filed in a later year, such
                                    as 2024.</li>
                            </ul>
                            ...
                            <p>Like most websites, FreeTaxUSA.com uses log files and analytical software to track website
                                usage. The information collected may include IP addresses, browser types, browser
                                configuration, internet service providers (ISP), referring/exit pages, platform types, and
                            ...
                            <p>Technologies such as cookies or similar technology are used by FreeTaxUSA.com in order to
                                ...
                                cookies, you may still use our site, but your ability to use some features or areas of our
                                site may be limited. The types of cookies or tracking technologies we may use are defined
                                below: </p>
                            <p>Essential cookies are necessary for FreeTaxUSA.com to function properly. </p>
                            <p>Performance and Functionality cookies are used to enhance the performance and functionality
                                of FreeTaxUSA.com but are not essential to its use. Examples of these cookies include: A/B
                            ...
                            <p>Advertising cookies and tracking technologies are used to make advertising FreeTaxUSA.com
                                ...
                                properties and ad networks. Advertisers may use third-party cookies to provide personalized
                                FreeTaxUSA.com advertising. </p>
                            <p>Analytics cookies and tracking technologies are used to help understand how the website is
                                being used. Information gathered by analytics is anonymous and viewed in aggregate to see
                                broader traffic trends. </p>
                            <h2 class="t4 pt-3">hCaptcha</h2>
                            <p>We use the hCaptcha anti-bot service (hereinafter "hCaptcha") on our website. This service is
                                provided by Intuition Machines, Inc., a Delaware US Corporation ("IMI"). hCaptcha is used to
                                check whether the data entered on our website (such as on a login page or contact form) has
                                ...
                                analysis starts automatically as soon as the website or mobile app visitor enters a part of
                                the website or app with hCaptcha enabled. For the analysis, hCaptcha evaluates various
                                information (e.g. IP address, how long the visitor has been on the website or app, or mouse
                                movements made by the user). The data collected during the analysis will be forwarded to
                                IMI. hCaptcha analysis in the "invisible mode" may take place completely in the background.
                                Website or app visitors are not advised that such an analysis is taking place if the user is
                                not shown a challenge. IMI acts as a "service provider" for the purposes of State Privacy
                                Acts. For more information about hCaptcha and IMI's privacy policy and terms of use, please
                            ...
                            <p>Contests and giveaways have their own terms and conditions and should be referenced before
                                entering. </p>
                            ...
                            <p>Your contact information (email address and/or SMS information) may be used to keep you
                                ...
                                provide product and fulfillment information, and confirmation of credit card or direct-debit
                                payments. If you e-file your tax return, an email and/or SMS text will be sent to you
                                stating whether the IRS has accepted or rejected your e-filed tax return. If problems occur
                                with the transmission of your tax return, a customer support email may be sent out to
                                explain the problem. We'll also send you a confirmation email as a receipt when you pay for
                                any FreeTaxUSA.com services. </p>
                            <p>Occasionally, FreeTaxUSA.com will send out tax information or promotional material dealing
                                with our products. These are considered optional communications and you, as the recipient,
                                can specify whether or not you wish to receive this type of communication. This can be done
                                while creating your account, by using the Edit User Profile portion of the application after
                                signing in, by clicking on the "Unsubscribe" link in the footer of every optional email or
                            ...
                            <p>On rare occasions, it is necessary to send out a strictly service-related announcement. For
                            ...
                            <p>Customer support for FreeTaxUSA.com is provided through our tax application, email, or phone.
                                When a customer support request is received, we will reply via the customer support portion
                                of the application, email, or phone. Before you finish filing your tax return, if your
                                personally identifiable information changes, or if you no longer desire to use our service,
                                you may correct, update or delete it by signing in to your account and making any changes.
                                ...
                                will respond within a reasonable timeframe. Upon request and verification of your identity,
                                FreeTaxUSA.com will provide you with information about whether we hold any of your personal
                                information. Once the IRS accepts your e-filed tax return, no changes can be made to your
                                account that would change any of the information on the tax return. </p>
                            <p>We may use artificial intelligence (AI) to answer customer support inquiries. If AI is used
                                any information submitted by the customer through the customer support tool will be
                                processed using automated (AI) and manual (human) methods. The information given is solely
                                used for processing the questions submitted and improving the answers provided, and not for
                                any other purpose. </p>
                            <p>Subject to our Data Retention Policy, we will retain your information for as long as needed
                                to provide you services. We will retain and use your information outside of that policy only
                                as necessary to comply with our legal obligations, resolve disputes, and enforce our
                                agreements. </p>
                            <h2 class="t4 pt-3">Legal Disclosures</h2>
                            <p>Though every effort is made to preserve user privacy, in certain situations, FreeTaxUSA.com
                                ...
                                also disclose your personally identifiable information when required by law wherein we have
                                a good-faith belief that such action is necessary to protect our rights, protect your safety
                                or the safety of others, to investigate fraud to comply with a current judicial proceeding,
                            ...
                            <p>We do not, and will not, sell your personally identifiable information to third parties. We
                            ...
                            <p>We may provide necessary personally identifiable information to companies that provide
                                services, such as shipping your order, SMS authentication, customer support inquiries, fraud
                                detection, credit card processing, and sending emails. These companies are only authorized
                                to use this information to provide these services. </p>
                            <p>Customer reviews and information provided as part of the review are collected, stored, and
                                managed using a service provider. The review and some details provided by you may be shared
                                with the public. Account verification codes sent through text messaging or voice calls are
                                provided by third-party services. A customer's phone number will be forwarded to the service
                                in order to send the account verification code. </p>
                            <h2 class="t4 pt-3">Credit Card Processing</h2>
                            <p>If during the use of our application you order a product that requires payment, your credit
                                card or direct-debit payment will be processed by a payment processing company. The payment
                                processing companies that we use do not retain, share, store or use personally identifiable
                                information for any secondary purposes. No credit card information will be collected unless
                                there is a payment due. Your credit card data is only used to process your payment. </p>
                            <p>If you choose to pay any federal or state taxes owed amount by credit card, that transaction
                                will be handled by a third-party service and is subject to the service's terms of use and
                                privacy statement. </p>
                            ...
                            <p>In the event FreeTaxUSA.com goes through a business transition, such as a merger, being
                                acquired by another company, or selling a portion of its assets, the personally identifiable
                                information of users will, in most instances, be part of the assets transferred. Users will
                                be notified, via email and/or through a prominent notice on the FreeTaxUSA.com website, 30
                                days prior to a change of ownership or control of their personally identifiable information.
                                If as a result of the business transition, the personally identifiable information will be
                                used in a manner different from that stated at the time of collection, users will be given a
                            ...
                            <p>FreeTaxUSA.com maintains physical, electronic, and procedural safeguards that comply with
                                ...
                                website, it is protected both online and offline. FreeTaxUSA.com uses Secure Socket Layer
                                (SSL) encryption technology to protect all sensitive information. SSL technology is the most
                                commonly used method on the Internet to safely transmit data. Access to your personally
                                identifiable information is protected by a password, of your choosing, in order to maintain
