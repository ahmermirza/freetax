                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <br>
                                                <label class="form-form-label h6" for="ssn"><b>Box A</b> - Employee's
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 1</b> - Wages
                                                    and Tips:</label>
                                            ...
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 2</b> - Federal
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 3</b> - Social
                                            ...
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 4</b> - Social
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 5</b> - Medicare
                                            ...
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 6</b> - Medicare
                                                    Tax Withheld:</label>
                                                <div class="has-danger input-group mb-3">
                                                    <span
                                                        class="input-group-text bg-disabled text-dark @error('first_name') is-invalid border border-danger text-danger @enderror border-0 px-3"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 7</b> - Social
                                                    Security Tips:</label>
                                                <div class="has-danger input-group mb-3">
                                                    <span
                                                        class="input-group-text bg-disabled text-dark @error('first_name') is-invalid border border-danger text-danger @enderror border-0 px-3"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6" for="first_name"><b>Box 9</b></label>
                                                <div class="has-danger input-group mb-3">
                                                    <input class="form-control @error('first_name') is-invalid @enderror"
                                                        name="first_name" type="text" value="N/A"
                                                        aria-label="first_name" aria-describedby="basic-addon2" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <label class="form-form-label h6 pb-2" for="first_name"><b>Box 12</b></label>
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6 pb-2" for="first_name">Code:</label>
                                                <div class="has-danger input-group mb-3">
                                                    <select class="form-select @error('code') is-invalid @enderror"
                                                        name="code" aria-label="code" aria-describedby="basic-addon2">
                                                        <option value="" selected=""></option>
                                                        <option value="A">A: Uncollected SS or RRTA on tips</option>
                                                        ...
                                                        <option value="S">S: Employee 408(p) contributions</option>
                                                        ...
                                                        <option value="GG">GG: Section 83(i) qualified equity grants
                                                            income</option>
                                            ...
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6 pb-2" for="first_name">Amount:</label>
                                                <div class="has-danger input-group mb-3">
                                                    <span
                                                        class="input-group-text bg-disabled text-dark @error('first_name') is-invalid border border-danger text-danger @enderror border-0 px-3"
                                                        id="basic-addon2"><b>$</b></span><input
                                        ...
                                        <div class="row">
                                            <label class="form-form-label h6 pb-2" for="first_name"><b>Box 13</b></label>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <label class="form-form-label h6 pb-2" for="first_name">Third-Party Sick
                                                    Pay</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <label class="form-form-label h6 pb-2" for="first_name"><b>Box 15</b></label>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="form-form-label h6 pb-2" for="emp_state_id">Employer's State
                                                    ID Number::</label>
                                                <div class="has-danger input-group mb-3">
                                                    <span
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <label class="form-form-label h6 pb-2" for="loca_income_tax"><b>Box 19</b>
                                                    - Local Income Tax:</label>
                                            </div>
                                            <div class="col-lg-4">
                                                <label class="form-form-label h6 pb-2" for="locality_name"><b>Box 20</b> -
                                                    Locality Name:</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row ms-1">
                                            <div class="col-lg-8 pb-5">
                                                <div class="has-danger form-check form-check-inline mb-3">
                                                    ...
                                                    <label class="form-check-label h6 pt-2" for="passed_away">Standard W-2
                                                        (most common)
                                                    </label>
                                                </div>
                                                <div class="has-danger form-check form-check-inline mb-3">
                                                    ...
                                                    <label class="form-check-label h6 pt-2" for="passed_away">Nonstandard
