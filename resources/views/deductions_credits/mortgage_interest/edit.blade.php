                                        ...
                                        <div class="col-lg-5 ms-3">
                                            ...
                                            <div class="has-danger input-group mb-3">
                                                <span
                                                    ...
                                                    name="deductible_mortgage" type="text" value="{{ ($mortgage_interest && $mortgage_interest->deductible_mortgage != null) ? $mortgage_interest->deductible_mortgage : '' }}" aria-label="deductible_mortgage"
                                        ...
                                        <div class="col-lg-5 ms-3">
                                            ...
                                            <div class="has-danger input-group mb-3">
                                                <span
                                                    ...
                                                    name="outstanding_mortgage" type="text" value="{{ ($mortgage_interest && $mortgage_interest->outstanding_mortgage != null) ? $mortgage_interest->outstanding_mortgage : '' }}" aria-label="outstanding_mortgage"
                                                    aria-describedby="basic-addon2" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-5 ms-3">
                                            ...
                                            <div class="has-danger input-group mb-3">
                                                <span
                                                    ...
                                                    name="refund_overpaid" type="text" value="{{ ($mortgage_interest && $mortgage_interest->refund_overpaid != null) ? $mortgage_interest->refund_overpaid : '' }}" aria-label="refund_overpaid"
                                                    aria-describedby="basic-addon2">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-5 ms-3">
                                            ...
                                            <div class="has-danger input-group mb-3">
                                                <span
                                                    ...
                                                    name="points_paid" type="text" value="{{ ($mortgage_interest && $mortgage_interest->points_paid != null) ? $mortgage_interest->points_paid : '' }}"
